...
class MyCentralManagerArgs {
  ...
  MyBluetoothLowEnergyStateArgs stateArgs;
  ...
  static MyCentralManagerArgs decode(Object result) {
    ...
    return MyCentralManagerArgs(
      stateArgs: MyBluetoothLowEnergyStateArgs.values[result[0]! as int],
    );
  }
}
...
class MyConnectionArgs {
  ...
  static MyConnectionArgs decode(Object result) {
    result as List<Object?>;
    return MyConnectionArgs(
      mtuArgs: result[0]! as int,
    );
  }
}
...
class _MyCentralManagerHostAPICodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    } else if (value is MyConnectionArgs) {
      buffer.putUint8(129);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 129: 
        return MyConnectionArgs.decode(readValue(buffer)!);
      case 130: 
...
class MyCentralManagerHostAPI {
  ...
  Future<MyConnectionArgs> connect(int addressArgs) async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as MyConnectionArgs?)!;
    }
  }
