...
void main() {
  final BluetoothLowEnergyWindowsPlatform initialPlatform =
      BluetoothLowEnergyWindowsPlatform.instance;

  test('$MethodChannelBluetoothLowEnergyWindows is the default instance', () {
    expect(initialPlatform,
        isInstanceOf<MethodChannelBluetoothLowEnergyWindows>());
  });

  test('getPlatformVersion', () async {
    BluetoothLowEnergyWindows bluetoothLowEnergyWindows =
        BluetoothLowEnergyWindows();
    MockBluetoothLowEnergyWindowsPlatform fakePlatform =
        MockBluetoothLowEnergyWindowsPlatform();
    BluetoothLowEnergyWindowsPlatform.instance = fakePlatform;

    expect(await bluetoothLowEnergyWindows.getPlatformVersion(), '42');
  });
}
