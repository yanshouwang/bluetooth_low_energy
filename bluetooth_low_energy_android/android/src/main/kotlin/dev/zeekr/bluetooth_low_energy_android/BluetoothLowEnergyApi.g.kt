...
/** Generated class from Pigeon that represents data sent in messages. */
data class BondedDeviceArgs (
  val addressArgs: String,
  val nameArgs: String? = null
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): BondedDeviceArgs {
      val addressArgs = pigeonVar_list[0] as String
      val nameArgs = pigeonVar_list[1] as String?
      return BondedDeviceArgs(addressArgs, nameArgs)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as BondedDeviceArgs
...
interface CentralManagerHostApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: CentralManagerHostApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.CentralManagerHostApi.getBondedDevices$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.CentralManagerHostApi.openL2CAPChannel$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val addressArgsArg = args[0] as String
            val psmArgsArg = args[1] as Long
            api.openL2CAPChannel(addressArgsArg, psmArgsArg) { result: Result<Long> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(BluetoothLowEnergyApiPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.CentralManagerHostApi.writeL2CAPChannel$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val idArgsArg = args[0] as Long
            val valueArgsArg = args[1] as ByteArray
            api.writeL2CAPChannel(idArgsArg, valueArgsArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(BluetoothLowEnergyApiPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.CentralManagerHostApi.closeL2CAPChannel$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val idArgsArg = args[0] as Long
            api.closeL2CAPChannel(idArgsArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(BluetoothLowEnergyApiPigeonUtils.wrapError(error))
              } else {
  ...
  fun onCharacteristicNotified(peripheralArgsArg: PeripheralArgs, characteristicArgsArg: GATTCharacteristicArgs, valueArgsArg: ByteArray, callback: (Result<Unit>) -> Unit)
{
  ...
  fun onL2CAPChannelReceived(idArgsArg: Long, valueArgsArg: ByteArray, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.bluetooth_low_energy_android.CentralManagerFlutterApi.onL2CAPChannelReceived$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(idArgsArg, valueArgsArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
  ...
  fun onL2CAPChannelClosed(idArgsArg: Long, errorArgsArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.bluetooth_low_energy_android.CentralManagerFlutterApi.onL2CAPChannelClosed$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(idArgsArg, errorArgsArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(FlutterError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
