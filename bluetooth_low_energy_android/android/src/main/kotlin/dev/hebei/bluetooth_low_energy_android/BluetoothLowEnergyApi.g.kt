...
private object BluetoothLowEnergyApiPigeonUtils {
  ...
  fun createConnectionError(channelName: String): BluetoothLowEnergyError {
...
data class ManufacturerSpecificDataApi (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is ManufacturerSpecificDataApi) {
      return false
    }
    if (this === other) {
      return true
...
data class GATTCharacteristicApi (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is GATTCharacteristicApi) {
      return false
    }
    if (this === other) {
      return true
...
data class MutableGATTDescriptorApi (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is MutableGATTDescriptorApi) {
      return false
    }
    if (this === other) {
      return true
...
data class MutableGATTCharacteristicApi (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is MutableGATTCharacteristicApi) {
      return false
    }
    if (this === other) {
      return true
...
data class MutableGATTServiceApi (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is MutableGATTServiceApi) {
      return false
    }
    if (this === other) {
      return true
...
data class GATTReadRequestApi (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is GATTReadRequestApi) {
      return false
    }
    if (this === other) {
      return true
...
data class GATTWriteRequestApi (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is GATTWriteRequestApi) {
      return false
    }
    if (this === other) {
      return true
...
interface PeripheralManagerHostApi {
  ...
  fun notifyCharacteristic(id: Long, value: ByteArray, addresses: List<String>?, callback: (Result<Unit>) -> Unit)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.notifyCharacteristic(idArg, valueArg, addressesArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(BluetoothLowEnergyApiPigeonUtils.wrapError(error))
              } else {
