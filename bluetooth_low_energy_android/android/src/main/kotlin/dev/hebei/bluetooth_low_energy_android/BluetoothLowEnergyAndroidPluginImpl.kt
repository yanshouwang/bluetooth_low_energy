...
class BluetoothLowEnergyAndroidPluginImpl(
    registrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar, val instance: BluetoothLowEnergyAndroidPlugin
) : PigeonApiBluetoothLowEnergyAndroidPlugin(registrar) {
    override fun instance(): BluetoothLowEnergyAndroidPlugin {
        return instance
    }

    override fun context(pigeon_instance: BluetoothLowEnergyAndroidPlugin): Context {
