...
class RequestPermissionsResultListenerApi(registrar: BluetoothLowEnergyAndroidPigeonProxyApiRegistrar) :
    ...
    override fun pigeon_defaultConstructor(): PluginRegistry.RequestPermissionsResultListener {
        return object : PluginRegistry.RequestPermissionsResultListener {
            override fun onRequestPermissionsResult(
                ...
                this@RequestPermissionsResultListenerApi.onRequestPermissionsResult(
