...
abstract class BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar(val binaryMessenger: BinaryMessenger) {
   ...
   */
  abstract fun getPigeonApiRequestPermissionsResultListener(): PigeonApiRequestPermissionsResultListener
   ...
   */
  abstract fun getPigeonApiActivityResultListener(): PigeonApiActivityResultListener
  ...
  /**
   * An implementation of [PigeonApiPackageManager] used to add a new Dart instance of
   * `PackageManager` to the Dart `InstanceManager`.
   */
  abstract fun getPigeonApiPackageManager(): PigeonApiPackageManager

  /**
   * An implementation of [PigeonApiBundle] used to add a new Dart instance of
   * `Bundle` to the Dart `InstanceManager`.
   */
  open fun getPigeonApiBundle(): PigeonApiBundle
  {
    return PigeonApiBundle(this)
  }
  ...
  /**
   * An implementation of [PigeonApiActivityCompat] used to add a new Dart instance of
   * `ActivityCompat` to the Dart `InstanceManager`.
   */
  abstract fun getPigeonApiActivityCompat(): PigeonApiActivityCompat
  ...
  fun setUp() {
    ...
    PigeonApiRequestPermissionsResultListener.setUpMessageHandlers(binaryMessenger, getPigeonApiRequestPermissionsResultListener())
    PigeonApiActivityResultListener.setUpMessageHandlers(binaryMessenger, getPigeonApiActivityResultListener())
    ...
    PigeonApiActivityCompat.setUpMessageHandlers(binaryMessenger, getPigeonApiActivityCompat())
  ...
  fun tearDown() {
    ...
    PigeonApiRequestPermissionsResultListener.setUpMessageHandlers(binaryMessenger, null)
    PigeonApiActivityResultListener.setUpMessageHandlers(binaryMessenger, null)
    ...
    PigeonApiActivityCompat.setUpMessageHandlers(binaryMessenger, null)
...
private class BluetoothLowEnergyAndroidApiPigeonProxyApiBaseCodec(val registrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) : BluetoothLowEnergyAndroidApiPigeonCodec() {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?) {
    if (value is Boolean || value is ByteArray || value is Double || value is DoubleArray || value is FloatArray || value is Int || value is IntArray || value is List<*> || value is Long || value is LongArray || value is Map<*, *> || value is String || value is Feature || value is Permission || value is RegisterReceiverFlags || value is BluetoothAdapterState || value is BluetoothStatusCodes || value == null) {
    ...
    if (value is dev.hebei.bluetooth_low_energy_android.BluetoothLowEnergyAndroidPlugin) {
     ...
     else if (value is android.content.pm.PackageManager) {
      registrar.getPigeonApiPackageManager().pigeon_newInstance(value) { }
    }
     else if (value is android.os.Bundle) {
      registrar.getPigeonApiBundle().pigeon_newInstance(value) { }
    }
     ...
     else if (value is androidx.core.app.ActivityCompat) {
      registrar.getPigeonApiActivityCompat().pigeon_newInstance(value) { }
    }
...
abstract class PigeonApiBluetoothLowEnergyAndroidPlugin(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  abstract fun instance(): dev.hebei.bluetooth_low_energy_android.BluetoothLowEnergyAndroidPlugin

  abstract fun context(pigeon_instance: dev.hebei.bluetooth_low_energy_android.BluetoothLowEnergyAndroidPlugin): android.content.Context
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiBluetoothLowEnergyAndroidPlugin?) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.BluetoothLowEnergyAndroidPlugin.context", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiRequestPermissionsResultListener(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  abstract fun pigeon_defaultConstructor(): io.flutter.plugin.common.PluginRegistry.RequestPermissionsResultListener

  companion object {
    @Suppress("LocalVariableName")
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiRequestPermissionsResultListener?) {
      val codec = api?.pigeonRegistrar?.codec ?: BluetoothLowEnergyAndroidApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.RequestPermissionsResultListener.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
  ...
  fun pigeon_newInstance(pigeon_instanceArg: io.flutter.plugin.common.PluginRegistry.RequestPermissionsResultListener, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of RequestPermissionsResultListener, but the class has a nonnull callback method.", "")))
    }
  }

  fun onRequestPermissionsResult(pigeon_instanceArg: io.flutter.plugin.common.PluginRegistry.RequestPermissionsResultListener, requestCodeArg: Long, resultArg: Boolean, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
    ...
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(pigeon_instanceArg, requestCodeArg, resultArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
          callback(Result.failure(BluetoothLowEnergyAndroidError(it[0] as String, it[1] as String, it[2] as String?)))
        } else {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiActivityResultListener(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  abstract fun pigeon_defaultConstructor(): io.flutter.plugin.common.PluginRegistry.ActivityResultListener

  companion object {
    @Suppress("LocalVariableName")
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiActivityResultListener?) {
      val codec = api?.pigeonRegistrar?.codec ?: BluetoothLowEnergyAndroidApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.ActivityResultListener.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
  ...
  fun pigeon_newInstance(pigeon_instanceArg: io.flutter.plugin.common.PluginRegistry.ActivityResultListener, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of ActivityResultListener, but the class has a nonnull callback method.", "")))
    }
  }
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAny(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
open class PigeonApiActivity(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
open class PigeonApiPendingIntent(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothAdapter(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
   ...
   * STATE_TURNING_OFF.
   */
  abstract fun getState(pigeon_instance: android.bluetooth.BluetoothAdapter): BluetoothAdapterState
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothClass(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothDevice(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothGatt(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothGattCallback(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.bluetooth.BluetoothGattCallback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of BluetoothGattCallback, but the class has a nonnull callback method.", "")))
    }
  }
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothGattCharacteristic(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothGattDescriptor(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothGattServer(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothGattServerCallback(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.bluetooth.BluetoothGattServerCallback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of BluetoothGattServerCallback, but the class has a nonnull callback method.", "")))
    }
  }
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothGattService(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothManager(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothServerSocket(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothSocket(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiLeScanCallback(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.bluetooth.BluetoothAdapter.LeScanCallback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of LeScanCallback, but the class has a nonnull callback method.", "")))
    }
  }
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothProfile(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiServiceListener(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.bluetooth.BluetoothProfile.ServiceListener, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of ServiceListener, but the class has a nonnull callback method.", "")))
    }
  }
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertiseCallback(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.bluetooth.le.AdvertiseCallback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of AdvertiseCallback, but the class has a nonnull callback method.", "")))
    }
  }
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertiseData(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertiseDataBuilder(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertiseSettings(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertiseSettingsBuilder(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertisingSet(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertisingSetCallback(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @androidx.annotation.RequiresApi(api = 26)
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.bluetooth.le.AdvertisingSetCallback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of AdvertisingSetCallback, but the class has a nonnull callback method.", "")))
    }
  }
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertisingSetParameters(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiAdvertisingSetParametersBuilder(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @androidx.annotation.RequiresApi(api = 26)
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothLeAdvertiser(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBluetoothLeScanner(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiPeriodicAdvertisingParameters(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /** Returns whether the TX Power will be included. */
  @androidx.annotation.RequiresApi(api = 26)
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiPeriodicAdvertisingParametersBuilder(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @androidx.annotation.RequiresApi(api = 26)
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiScanCallback(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.bluetooth.le.ScanCallback, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of ScanCallback, but the class has a nonnull callback method.", "")))
    }
  }
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiScanFilter(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiScanFilterBuilder(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiScanRecord(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiScanResult(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiScanSettings(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiScanSettingsBuilder(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
open class PigeonApiTransportBlock(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
open class PigeonApiTransportDiscoveryData(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiBroadcastReceiver(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiBroadcastReceiver?) {
      val codec = api?.pigeonRegistrar?.codec ?: BluetoothLowEnergyAndroidApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.BroadcastReceiver.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.content.BroadcastReceiver, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      callback(
          Result.failure(
              BluetoothLowEnergyAndroidError("new-instance-error", "Attempting to create a new Dart instance of BroadcastReceiver, but the class has a nonnull callback method.", "")))
    }
  }
  ...
  fun onReceive(pigeon_instanceArg: android.content.BroadcastReceiver, contextArg: android.content.Context, intentArg: android.content.Intent, callback: (Result<Unit>) -> Unit)
{
    ...
    val binaryMessenger = pigeonRegistrar.binaryMessenger
    val codec = pigeonRegistrar.codec
    val channelName = "dev.flutter.pigeon.bluetooth_low_energy_android.BroadcastReceiver.onReceive"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiContext(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
open class PigeonApiIntent(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiIntentFilter(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /** New empty IntentFilter. */
  abstract fun new1(): android.content.IntentFilter

  /** New IntentFilter containing a copy of an existing filter. */
  abstract fun new2(o: android.content.IntentFilter): android.content.IntentFilter
   ...
   */
  abstract fun new3(action: String): android.content.IntentFilter
   ...
   * correct.
   */
  abstract fun new4(action: String, dataType: String): android.content.IntentFilter
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiIntentFilter?) {
      val codec = api?.pigeonRegistrar?.codec ?: BluetoothLowEnergyAndroidApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.IntentFilter.new1", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
            val wrapped: List<Any?> = try {
              api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.new1(), pigeon_identifierArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.IntentFilter.new2", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
            val oArg = args[1] as android.content.IntentFilter
            val wrapped: List<Any?> = try {
              api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.new2(oArg), pigeon_identifierArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.IntentFilter.new3", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
            ...
            val wrapped: List<Any?> = try {
              api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.new3(actionArg), pigeon_identifierArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.IntentFilter.new4", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
            val actionArg = args[1] as String
            val dataTypeArg = args[2] as String
            val wrapped: List<Any?> = try {
              api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.new4(actionArg,dataTypeArg), pigeon_identifierArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: android.content.IntentFilter, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      val binaryMessenger = pigeonRegistrar.binaryMessenger
      val codec = pigeonRegistrar.codec
      val channelName = "dev.flutter.pigeon.bluetooth_low_energy_android.IntentFilter.pigeon_newInstance"
      val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
      channel.send(listOf(pigeon_identifierArg)) {
        if (it is List<*>) {
          if (it.size > 1) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiPackageManager(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
  ...
  companion object {
    @Suppress("LocalVariableName")
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiPackageManager?) {
      val codec = api?.pigeonRegistrar?.codec ?: BluetoothLowEnergyAndroidApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.PackageManager.hasSystemFeature", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
  ...
  @Suppress("LocalVariableName", "FunctionName")
  /** Creates a Dart instance of PackageManager and attaches it to [pigeon_instanceArg]. */
  fun pigeon_newInstance(pigeon_instanceArg: android.content.pm.PackageManager, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
      ...
      val binaryMessenger = pigeonRegistrar.binaryMessenger
      val codec = pigeonRegistrar.codec
      val channelName = "dev.flutter.pigeon.bluetooth_low_energy_android.PackageManager.pigeon_newInstance"
      val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
      channel.send(listOf(pigeon_identifierArg)) {
        if (it is List<*>) {
          if (it.size > 1) {
 ...
 */
@Suppress("UNCHECKED_CAST")
open class PigeonApiBundle(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
  /** Creates a Dart instance of Bundle and attaches it to [pigeon_instanceArg]. */
  fun pigeon_newInstance(pigeon_instanceArg: android.os.Bundle, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
      ...
      val binaryMessenger = pigeonRegistrar.binaryMessenger
      val codec = pigeonRegistrar.codec
      val channelName = "dev.flutter.pigeon.bluetooth_low_energy_android.Bundle.pigeon_newInstance"
      val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
      channel.send(listOf(pigeon_identifierArg)) {
        if (it is List<*>) {
          if (it.size > 1) {
 ...
 */
@Suppress("UNCHECKED_CAST")
open class PigeonApiHandler(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiParcelUuid(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
...
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiActivityCompat(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  /**
   ...
   */
  abstract fun startActivityForResult(activity: android.app.Activity, intent: android.content.Intent, requestCode: Long, options: android.os.Bundle?)

  companion object {
    @Suppress("LocalVariableName")
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiActivityCompat?) {
      val codec = api?.pigeonRegistrar?.codec ?: BluetoothLowEnergyAndroidApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.ActivityCompat.requestPermissions", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.ActivityCompat.startActivityForResult", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val activityArg = args[0] as android.app.Activity
            val intentArg = args[1] as android.content.Intent
            val requestCodeArg = args[2] as Long
            val optionsArg = args[3] as android.os.Bundle?
            val wrapped: List<Any?> = try {
              api.startActivityForResult(activityArg, intentArg, requestCodeArg, optionsArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
  ...
  @Suppress("LocalVariableName", "FunctionName")
  /** Creates a Dart instance of ActivityCompat and attaches it to [pigeon_instanceArg]. */
  fun pigeon_newInstance(pigeon_instanceArg: androidx.core.app.ActivityCompat, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      callback(
          Result.failure(
      ...
      val binaryMessenger = pigeonRegistrar.binaryMessenger
      val codec = pigeonRegistrar.codec
      val channelName = "dev.flutter.pigeon.bluetooth_low_energy_android.ActivityCompat.pigeon_newInstance"
      val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
      channel.send(listOf(pigeon_identifierArg)) {
        if (it is List<*>) {
          if (it.size > 1) {
  ...
  @Suppress("FunctionName")
  /** An implementation of [PigeonApiContextCompat] used to access callback methods */
  fun pigeon_getPigeonApiContextCompat(): PigeonApiContextCompat
  {
    return pigeonRegistrar.getPigeonApiContextCompat()
  }

}
/** Helper for accessing features in Context. */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiContextCompat(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
   ...
   * be launched normally.
   */
  abstract fun startActivity(context: android.content.Context, intent: android.content.Intent, options: android.os.Bundle?)
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiContextCompat?) {
      val codec = api?.pigeonRegistrar?.codec ?: BluetoothLowEnergyAndroidApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.ContextCompat.checkSelfPermission", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.ContextCompat.getBluetoothManager", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val contextArg = args[0] as android.content.Context
            val wrapped: List<Any?> = try {
              listOf(api.getBluetoothManager(contextArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.ContextCompat.registerReceiver1", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val contextArg = args[0] as android.content.Context
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.ContextCompat.registerReceiver2", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val contextArg = args[0] as android.content.Context
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.bluetooth_low_energy_android.ContextCompat.startActivity", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val contextArg = args[0] as android.content.Context
            val intentArg = args[1] as android.content.Intent
            val optionsArg = args[2] as android.os.Bundle?
            val wrapped: List<Any?> = try {
              api.startActivity(contextArg, intentArg, optionsArg)
              listOf(null)
            } catch (exception: Throwable) {
              wrapError(exception)
            }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: androidx.core.content.ContextCompat, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      val binaryMessenger = pigeonRegistrar.binaryMessenger
      val codec = pigeonRegistrar.codec
      val channelName = "dev.flutter.pigeon.bluetooth_low_energy_android.ContextCompat.pigeon_newInstance"
      val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
      channel.send(listOf(pigeon_identifierArg)) {
        if (it is List<*>) {
          if (it.size > 1) {
 ...
 */
@Suppress("UNCHECKED_CAST")
open class PigeonApiInputStream(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
open class PigeonApiOutputStream(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
open class PigeonApiDuration(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
  @Suppress("LocalVariableName", "FunctionName")
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiUUID(open val pigeonRegistrar: BluetoothLowEnergyAndroidApiPigeonProxyApiRegistrar) {
