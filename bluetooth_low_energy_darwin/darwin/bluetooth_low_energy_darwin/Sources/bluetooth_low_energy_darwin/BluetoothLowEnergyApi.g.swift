...
private func doubleEqualsBluetoothLowEnergyApi(_ lhs: Double, _ rhs: Double) -> Bool {
  return (lhs.isNaN && rhs.isNaN) || lhs == rhs
}

private func doubleHashBluetoothLowEnergyApi(_ value: Double, _ hasher: inout Hasher) {
  if value.isNaN {
...
func deepEqualsBluetoothLowEnergyApi(_ lhs: Any?, _ rhs: Any?) -> Bool {
  ...
  case (let lhsArray, let rhsArray) as ([Any?], [Any?]):
    ...
    for (index, element) in lhsArray.enumerated() {
      if !deepEqualsBluetoothLowEnergyApi(element, rhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case (let lhsArray, let rhsArray) as ([Double], [Double]):
    guard lhsArray.count == rhsArray.count else { return false }
    for (index, element) in lhsArray.enumerated() {
      if !doubleEqualsBluetoothLowEnergyApi(element, rhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case (let lhsDictionary, let rhsDictionary) as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    for (lhsKey, lhsValue) in lhsDictionary {
      ...
      for (rhsKey, rhsValue) in rhsDictionary {
        if deepEqualsBluetoothLowEnergyApi(lhsKey, rhsKey) {
          if deepEqualsBluetoothLowEnergyApi(lhsValue, rhsValue) {
            found = true
            break
          } else {
            return false
  ...
  case (let lhs as Double, let rhs as Double):
    return doubleEqualsBluetoothLowEnergyApi(lhs, rhs)
...
func deepHashBluetoothLowEnergyApi(value: Any?, hasher: inout Hasher) {
  ...
  if let cleanValue = cleanValue {
    if let doubleValue = cleanValue as? Double {
      doubleHashBluetoothLowEnergyApi(doubleValue, &hasher)
    } else if let valueList = cleanValue as? [Any?] {
      for item in valueList {
        deepHashBluetoothLowEnergyApi(value: item, hasher: &hasher)
      }
    } else if let valueList = cleanValue as? [Double] {
      for item in valueList {
        doubleHashBluetoothLowEnergyApi(item, &hasher)
      }
    } else if let valueDict = cleanValue as? [AnyHashable: Any?] {
      var result = 0
      for (key, value) in valueDict {
        var entryKeyHasher = Hasher()
        deepHashBluetoothLowEnergyApi(value: key, hasher: &entryKeyHasher)
        var entryValueHasher = Hasher()
        deepHashBluetoothLowEnergyApi(value: value, hasher: &entryValueHasher)
...
struct AdvertisementArgs: Hashable {
  ...
  static func == (lhs: AdvertisementArgs, rhs: AdvertisementArgs) -> Bool {
    ...
    return deepEqualsBluetoothLowEnergyApi(lhs.nameArgs, rhs.nameArgs) && deepEqualsBluetoothLowEnergyApi(lhs.serviceUUIDsArgs, rhs.serviceUUIDsArgs) && deepEqualsBluetoothLowEnergyApi(lhs.serviceDataArgs, rhs.serviceDataArgs) && deepEqualsBluetoothLowEnergyApi(lhs.manufacturerSpecificDataArgs, rhs.manufacturerSpecificDataArgs)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("AdvertisementArgs")
    deepHashBluetoothLowEnergyApi(value: nameArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: serviceUUIDsArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: serviceDataArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: manufacturerSpecificDataArgs, hasher: &hasher)
  }
}
...
struct GATTDescriptorArgs: Hashable {
  ...
  static func == (lhs: GATTDescriptorArgs, rhs: GATTDescriptorArgs) -> Bool {
    ...
    return deepEqualsBluetoothLowEnergyApi(lhs.hashCodeArgs, rhs.hashCodeArgs) && deepEqualsBluetoothLowEnergyApi(lhs.uuidArgs, rhs.uuidArgs)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("GATTDescriptorArgs")
    deepHashBluetoothLowEnergyApi(value: hashCodeArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: uuidArgs, hasher: &hasher)
  }
}
...
struct GATTCharacteristicArgs: Hashable {
  ...
  static func == (lhs: GATTCharacteristicArgs, rhs: GATTCharacteristicArgs) -> Bool {
    ...
    return deepEqualsBluetoothLowEnergyApi(lhs.hashCodeArgs, rhs.hashCodeArgs) && deepEqualsBluetoothLowEnergyApi(lhs.uuidArgs, rhs.uuidArgs) && deepEqualsBluetoothLowEnergyApi(lhs.propertyNumbersArgs, rhs.propertyNumbersArgs) && deepEqualsBluetoothLowEnergyApi(lhs.descriptorsArgs, rhs.descriptorsArgs)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("GATTCharacteristicArgs")
    deepHashBluetoothLowEnergyApi(value: hashCodeArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: uuidArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: propertyNumbersArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: descriptorsArgs, hasher: &hasher)
  }
}
...
struct GATTServiceArgs: Hashable {
  ...
  static func == (lhs: GATTServiceArgs, rhs: GATTServiceArgs) -> Bool {
    ...
    return deepEqualsBluetoothLowEnergyApi(lhs.hashCodeArgs, rhs.hashCodeArgs) && deepEqualsBluetoothLowEnergyApi(lhs.uuidArgs, rhs.uuidArgs) && deepEqualsBluetoothLowEnergyApi(lhs.isPrimaryArgs, rhs.isPrimaryArgs) && deepEqualsBluetoothLowEnergyApi(lhs.includedServicesArgs, rhs.includedServicesArgs) && deepEqualsBluetoothLowEnergyApi(lhs.characteristicsArgs, rhs.characteristicsArgs)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("GATTServiceArgs")
    deepHashBluetoothLowEnergyApi(value: hashCodeArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: uuidArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: isPrimaryArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: includedServicesArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: characteristicsArgs, hasher: &hasher)
  }
}
...
struct MutableGATTDescriptorArgs: Hashable {
  ...
  static func == (lhs: MutableGATTDescriptorArgs, rhs: MutableGATTDescriptorArgs) -> Bool {
    ...
    return deepEqualsBluetoothLowEnergyApi(lhs.hashCodeArgs, rhs.hashCodeArgs) && deepEqualsBluetoothLowEnergyApi(lhs.uuidArgs, rhs.uuidArgs) && deepEqualsBluetoothLowEnergyApi(lhs.valueArgs, rhs.valueArgs)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("MutableGATTDescriptorArgs")
    deepHashBluetoothLowEnergyApi(value: hashCodeArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: uuidArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: valueArgs, hasher: &hasher)
  }
}
...
struct MutableGATTCharacteristicArgs: Hashable {
  ...
  static func == (lhs: MutableGATTCharacteristicArgs, rhs: MutableGATTCharacteristicArgs) -> Bool {
    ...
    return deepEqualsBluetoothLowEnergyApi(lhs.hashCodeArgs, rhs.hashCodeArgs) && deepEqualsBluetoothLowEnergyApi(lhs.uuidArgs, rhs.uuidArgs) && deepEqualsBluetoothLowEnergyApi(lhs.propertyNumbersArgs, rhs.propertyNumbersArgs) && deepEqualsBluetoothLowEnergyApi(lhs.permissionNumbersArgs, rhs.permissionNumbersArgs) && deepEqualsBluetoothLowEnergyApi(lhs.valueArgs, rhs.valueArgs) && deepEqualsBluetoothLowEnergyApi(lhs.descriptorsArgs, rhs.descriptorsArgs)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("MutableGATTCharacteristicArgs")
    deepHashBluetoothLowEnergyApi(value: hashCodeArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: uuidArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: propertyNumbersArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: permissionNumbersArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: valueArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: descriptorsArgs, hasher: &hasher)
  }
}
...
struct MutableGATTServiceArgs: Hashable {
  ...
  func hash(into hasher: inout Hasher) {
    hasher.combine("MutableGATTServiceArgs")
    deepHashBluetoothLowEnergyApi(value: hashCodeArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: uuidArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: isPrimaryArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: includedServicesArgs, hasher: &hasher)
...
struct ATTRequestArgs: Hashable {
  ...
  static func == (lhs: ATTRequestArgs, rhs: ATTRequestArgs) -> Bool {
    ...
    return deepEqualsBluetoothLowEnergyApi(lhs.hashCodeArgs, rhs.hashCodeArgs) && deepEqualsBluetoothLowEnergyApi(lhs.centralArgs, rhs.centralArgs) && deepEqualsBluetoothLowEnergyApi(lhs.characteristicHashCodeArgs, rhs.characteristicHashCodeArgs) && deepEqualsBluetoothLowEnergyApi(lhs.valueArgs, rhs.valueArgs) && deepEqualsBluetoothLowEnergyApi(lhs.offsetArgs, rhs.offsetArgs)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("ATTRequestArgs")
    deepHashBluetoothLowEnergyApi(value: hashCodeArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: centralArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: characteristicHashCodeArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: valueArgs, hasher: &hasher)
    deepHashBluetoothLowEnergyApi(value: offsetArgs, hasher: &hasher)
  }
}
...
protocol CentralManagerFlutterApiProtocol {
  ...
  func onConnectionStateChanged(peripheralArgs peripheralArgsArg: PeripheralArgs, statusArgs statusArgsArg: Int64, stateArgs stateArgsArg: ConnectionStateArgs, completion: @escaping (Result<Void, PigeonError>) -> Void)
...
class CentralManagerFlutterApi: CentralManagerFlutterApiProtocol {
  ...
  func onConnectionStateChanged(peripheralArgs peripheralArgsArg: PeripheralArgs, statusArgs statusArgsArg: Int64, stateArgs stateArgsArg: ConnectionStateArgs, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    ...
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([peripheralArgsArg, statusArgsArg, stateArgsArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
