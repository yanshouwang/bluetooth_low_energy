...
struct MyMutableGATTDescriptorArgs {
  ...
  static func fromList(_ list: [Any?]) -> MyMutableGATTDescriptorArgs? {
    let hashCodeArgs = list[0] is Int64 ? list[0] as! Int64 : Int64(list[0] as! Int32)
    let uuidArgs = list[1] as! String
...
struct MyMutableGATTCharacteristicArgs {
  ...
  static func fromList(_ list: [Any?]) -> MyMutableGATTCharacteristicArgs? {
    let hashCodeArgs = list[0] is Int64 ? list[0] as! Int64 : Int64(list[0] as! Int32)
    let uuidArgs = list[1] as! String
    let propertyNumbersArgs = list[2] as! [Int64?]
    let valueArgs: FlutterStandardTypedData? = nilOrValue(list[3])
    let descriptorsArgs = list[4] as! [MyMutableGATTDescriptorArgs?]
...
struct MyMutableGATTServiceArgs {
  ...
  static func fromList(_ list: [Any?]) -> MyMutableGATTServiceArgs? {
    let hashCodeArgs = list[0] is Int64 ? list[0] as! Int64 : Int64(list[0] as! Int32)
    let uuidArgs = list[1] as! String
    let characteristicsArgs = list[2] as! [MyMutableGATTCharacteristicArgs?]
...
struct MyATTRequestArgs {
  ...
  static func fromList(_ list: [Any?]) -> MyATTRequestArgs? {
    let hashCodeArgs = list[0] is Int64 ? list[0] as! Int64 : Int64(list[0] as! Int32)
    let centralArgs = MyCentralArgs.fromList(list[1] as! [Any?])!
    let characteristicHashCodeArgs = list[2] is Int64 ? list[2] as! Int64 : Int64(list[2] as! Int32)
    let valueArgs: FlutterStandardTypedData? = nilOrValue(list[3])
    let offsetArgs = list[4] is Int64 ? list[4] as! Int64 : Int64(list[4] as! Int32)
...
class MyCentralManagerHostAPISetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MyCentralManagerHostAPI?, messageChannelSuffix: String = "") {
    ...
    let maximumWriteValueLengthChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_low_energy_darwin.MyCentralManagerHostAPI.maximumWriteValueLength\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class MyPeripheralManagerHostAPISetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MyPeripheralManagerHostAPI?, messageChannelSuffix: String = "") {
    ...
    let clearServicesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_low_energy_darwin.MyPeripheralManagerHostAPI.clearServices\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let maximumUpdateValueLengthChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.bluetooth_low_energy_darwin.MyPeripheralManagerHostAPI.maximumUpdateValueLength\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      maximumUpdateValueLengthChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let uuidArgsArg = args[0] as! String
        do {
          let result = try api.maximumUpdateValueLength(uuidArgs: uuidArgsArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      maximumUpdateValueLengthChannel.setMessageHandler(nil)
    }
