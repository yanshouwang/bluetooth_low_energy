...
class CentralArgs {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(uuidArgs, other.uuidArgs);
  }
...
class PeripheralArgs {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(uuidArgs, other.uuidArgs) && _deepEquals(nameArgs, other.nameArgs);
  }
...
class MutableGATTDescriptorArgs {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(hashCodeArgs, other.hashCodeArgs) && _deepEquals(uuidArgs, other.uuidArgs) && _deepEquals(valueArgs, other.valueArgs);
  }
...
class MutableGATTCharacteristicArgs {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(hashCodeArgs, other.hashCodeArgs) && _deepEquals(uuidArgs, other.uuidArgs) && _deepEquals(propertyNumbersArgs, other.propertyNumbersArgs) && _deepEquals(permissionNumbersArgs, other.permissionNumbersArgs) && _deepEquals(valueArgs, other.valueArgs) && _deepEquals(descriptorsArgs, other.descriptorsArgs);
  }
...
class ATTRequestArgs {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(hashCodeArgs, other.hashCodeArgs) && _deepEquals(centralArgs, other.centralArgs) && _deepEquals(characteristicHashCodeArgs, other.characteristicHashCodeArgs) && _deepEquals(valueArgs, other.valueArgs) && _deepEquals(offsetArgs, other.offsetArgs);
  }
...
class CentralManagerHostApi {
  ...
  Future<List<PeripheralArgs>> retrieveConnectedPeripherals(List<String> serviceUUIDsArgs) async {
  ...
  Future<int> openL2CAPChannel(String uuidArgs, int psmArgs) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.bluetooth_low_energy_darwin.CentralManagerHostApi.openL2CAPChannel$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[uuidArgs, psmArgs]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
  ...
  Future<void> closeL2CAPChannel(int idArgs) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.bluetooth_low_energy_darwin.CentralManagerHostApi.closeL2CAPChannel$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class CentralManagerFlutterApi {
  ...
  static void setUp(CentralManagerFlutterApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.bluetooth_low_energy_darwin.CentralManagerFlutterApi.onL2CAPChannelReceived$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.bluetooth_low_energy_darwin.CentralManagerFlutterApi.onL2CAPChannelClosed$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
