...
class MyMutableGATTServiceArgs {
  ...
  static MyMutableGATTServiceArgs decode(Object result) {
    ...
    return MyMutableGATTServiceArgs(
      hashCodeArgs: result[0]! as int,
      uuidArgs: result[1]! as String,
      characteristicsArgs: (result[2] as List<Object?>?)!.cast<MyMutableGATTCharacteristicArgs?>(),
    );
  }
}
...
class MyATTRequestArgs {
  ...
  static MyATTRequestArgs decode(Object result) {
    ...
    return MyATTRequestArgs(
      hashCodeArgs: result[0]! as int,
      centralArgs: MyCentralArgs.decode(result[1]! as List<Object?>),
...
class MyPeripheralManagerHostAPI {
  ...
  Future<void> clearServices() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.bluetooth_low_energy_darwin.MyPeripheralManagerHostAPI.clearServices$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<int> maximumUpdateValueLength(String uuidArgs) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.bluetooth_low_energy_darwin.MyPeripheralManagerHostAPI.maximumUpdateValueLength$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
